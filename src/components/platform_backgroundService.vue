    ...
    <div style="width: 1150px;height: 100%;margin: 0 auto 0;position: relative;">
      ...
      <el-card style="position: absolute;top: 20px;width: 100%;height: auto;margin-bottom: 50px;">
        ...
        <el-select
          ...
          clearable
          placeholder="请选择"
          style="position: absolute;left: 100px;width: 120px;"
          size="mini"
        >
          <el-option
        ...
        <el-select
          v-model="servicetype"
          placeholder="请选择活动区域"
          style="position: absolute;left: 330px;width: 130px;"
          size="mini"
        >
        ...
        <el-select
          v-model="servicelan"
          placeholder="请选择活动区域"
          style="position: absolute;left: 570px;width: 130px;"
          size="mini"
        >
          <el-option label="不限制" value></el-option>
        ...
        <div style="clear: both;margin-top: 40px;">
          ...
          <div
            ...
            :key="index"
            style="width: 100%;height: 300px;clear: both;position: relative;"
          >
            ...
            <div style="width: auto;height: auto;position: absolute;top: 50px;left: 20px;">
              <h3>
                ...
                >服务简介:</font>
                <div
                  style="width: 700px;overflow: hidden; text-overflow: ellipsis;white-space: nowrap; display: block;position: absolute;left: 70px;top: 19px;"
                >
                  <font
                    style="color: #606266;font-size: 0.7em;letter-spacing: 0.1em;font-weight: bold;"
                  >{{resource.synopsis}}</font>
                </div>
                <el-popover
                  placement="top"
                  title="简介"
            ...
            <div style="width: auto;height: auto;position: absolute;top: 80px;left: 20px;">
              <h3>
                <font
                  style="color: #C0C4CC;font-size: 0.7em;letter-spacing: 0.1em;font-weight: bolder;"
                >服务版本:</font>
                <font
                  style="color: #606266;font-size: 0.7em;letter-spacing: 0.1em;font-weight: bolder;"
                >{{resource.version}}</font>
              </h3>
            </div>
            <!-- 资源存放路径 -->
              ...
              <h3>
                ...
                >
                  ...
                  <el-tag
                    type="success"
                    size="small"
                    v-else-if="resource.type === 'Node.js'"
                  >Node.js</el-tag>
              ...
              <h3>
                ...
                >
                  ...
                  <el-tag
                    type="warning"
                    size="small"
                    v-else-if="resource.officialservice === false"
                  >第三方资源</el-tag>
            ...
            <div style="width: auto;height: auto;position: absolute;top: 230px;left: 20px;">
              <h3>
                ...
                <font
                  :key="index"
                  v-for="(file,index) in resource.annexe"
                  style="color: #606266;font-size: 0.7em;letter-spacing: 0.1em;font-weight: bold;margin-right: 5px;"
                >
            ...
            <el-dialog title="版本记录" :visible.sync="dialogTableVisible">
              <el-table :data="resource.historical" max-height="550" stripe>
